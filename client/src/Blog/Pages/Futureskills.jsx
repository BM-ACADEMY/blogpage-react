...
const Futureskills = () => {
  ...
  const whatsappUrl =
    "https://wa.me/919944940051?text=Hi%20BM%20Academy%2C%20I%20read%20your%20blog%20on%20New%20Year%20skills.%20I%20want%20to%20know%20more%20about%20your%20future-ready%20courses.";
...
Hi BM Academy, I would like to book a free counseling session based on your blog post.`;
  ...
  const blogSchema = {
    ...
    description:
      "Start 2026 with future-ready skills! Learn AI + Digital Marketing or AI + Full Stack Development at BM Academy. Free 3-day one-to-one counselling.",
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800 relative">
      ...
      <Helmet>
        <title>
          New Year, New Skill | AI + Digital Marketing & Full Stack Courses | BM
          Academy
        </title>
        <meta
          name="description"
          content="Start 2026 with future-ready skills! Learn AI + Digital Marketing or AI + Full Stack Development at BM Academy. Free 3-day one-to-one counselling."
        />
        <link
          rel="canonical"
          href="https://www.thebmacademy.com/blog/new-year-new-skill"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="New Year, New Skill | AI + Digital Marketing & Full Stack Courses | BM Academy"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="https://www.thebmacademy.com/assets/images/new-year-new-skill.jpg"
        />
        <meta
          property="og:url"
          content="https://www.thebmacademy.com/blog/new-year-new-skill"
        />
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <main className="lg:col-span-8">
          ...
          <div className="mb-8 rounded-xl overflow-hidden shadow-lg bg-gray-200 h-64 md:h-96 w-full relative group">
            ...
            <div className="absolute bottom-4 left-4 text-white">
              <p className="font-bold text-lg">
                Kickstart 2026 with In-Demand Skills
              </p>
            </div>
          </div>
          ...
          <article className="prose prose-lg max-w-none text-gray-700 space-y-10">
            ...
            <section>
              <p>
                As we step into a brand-new year, there’s no better time to
                rethink your goals and upgrade your skills. In today’s
                fast-moving job market, simply having a degree isn’t enough.
                Employers are prioritising future-ready skills that help
                ...
                empowers learners with industry-driven training that opens doors
            ...
            <section>
              ...
              <p>
                The global job landscape is rapidly evolving, and skills related
                to AI, digital technologies, and software development are seeing
              ...
              <div className="grid grid-cols-1 gap-6 mt-6">
                ...
                <div className="bg-white p-5 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition text-center md:text-left">
                  ...
                  <p className="text-sm">
                    AI fluency is becoming a baseline requirement across
                    industries. Employers value professionals who can use AI
                    tools to improve productivity, automate tasks, and make
                    data-driven decisions. Leadership roles related to AI have
                    also grown significantly, highlighting the importance of AI
                    expertise.
                  </p>
                </div>
                ...
                <div className="bg-white p-5 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition text-center md:text-left">
                  ...
                  <p className="text-sm">
                    Digital marketing roles continue to expand as businesses
                    invest more in online growth. Professionals skilled in
                    AI-powered marketing tools, analytics, and automation stand
                ...
                <div className="bg-white p-5 rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition text-center md:text-left">
                  ...
                  <p className="text-sm">
                    Full stack developers remain in high demand across
                    industries. Those who can integrate AI into applications
                    gain an added advantage, making them valuable assets to
                    modern tech teams.
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <p className="mb-6">
                At BM Academy, you can build skills that matter in 2026 and
                beyond:
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-white p-6 rounded-xl border border-blue-100 shadow-sm">
                  ...
                  <p className="mb-4 text-sm">
                    This course blends AI tools with modern digital marketing
                    strategies to help you:
                  </p>
                  <ul className="list-none space-y-2 mb-6 text-sm">
                    <li className="flex items-start">
                      <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-1 shrink-0" />{" "}
                      Automate and personalise campaigns
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-1 shrink-0" />{" "}
                      Analyse data for better ROI
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-1 shrink-0" />{" "}
                      Create high-impact content using AI tools
                    </li>
                  </ul>
                  <button
                    onClick={toggleModal}
                    className="w-full text-center text-sm font-bold text-white bg-blue-600 px-4 py-2 rounded-lg hover:bg-blue-700 transition"
                  >
                ...
                <div className="bg-gradient-to-br from-purple-50 to-white p-6 rounded-xl border border-purple-100 shadow-sm">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold text-purple-800">
                      <a
                        href="https://www.thebmacademy.com/fullstack.html"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="hover:underline"
                      >
                  ...
                  <p className="mb-4 text-sm">
                    This program prepares you to build dynamic applications and:
                  </p>
                  <ul className="list-none space-y-2 mb-6 text-sm">
                    <li className="flex items-start">
                      <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-1 shrink-0" />{" "}
                      Build dynamic end-to-end apps
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-1 shrink-0" />{" "}
                      Integrate AI features into software
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-1 shrink-0" />{" "}
                      Work confidently with frontend & backend
                    </li>
                  </ul>
                  <button
                    onClick={toggleModal}
                    className="w-full text-center text-sm font-bold text-white bg-purple-600 px-4 py-2 rounded-lg hover:bg-purple-700 transition"
                  >
                    Book Free Counselling
                  </button>
                </div>
            ...
            <section className="bg-orange-50 p-6 rounded-xl border border-orange-100">
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="md:w-2/3">
                  ...
                  <p className="mb-4">
                    Not sure which course suits you? BM Academy offers 3 days of
                    free personalised counselling to help you:
                  </p>
                  <ul className="space-y-2 mb-6">
                    ...
                    <li className="flex items-center">
                      <CheckCircle className="w-4 h-4 text-orange-500 mr-2" />{" "}
                      Plan your learning journey with clarity
                    </li>
                  </ul>
                  <button
                    onClick={toggleModal}
                    className="bg-orange-500 text-white px-6 py-2 rounded-full font-bold hover:bg-orange-600 transition shadow"
                  >
            ...
            <section>
              ...
              <p className="mt-4 italic text-gray-600">
                BM Academy helps students, professionals, and career-changers
            ...
            <section className="bg-blue-50 p-8 rounded-2xl text-center">
              ...
              <p className="mb-6 max-w-2xl mx-auto">
                “New Year, New Skill” is more than a slogan — it’s a strategic
                step toward future-proofing your career. With AI and digital
                skills in high demand, now is the perfect time to invest in
                yourself. Whether you’re starting fresh or upgrading your
                expertise,{" "}
                <a
                  href="https://www.thebmacademy.com/contact.html"
                  className="text-blue-600 font-bold hover:underline"
                ...
                gives you the right guidance, practical training, and
                industry-ready skills to move forward with confidence.
              </p>
              <div className="flex justify-center gap-4">
                ...
                >
                  Start Your New Skill Journey Today{" "}
              ...
              <div className="space-y-4">
                <div className="bg-white border border-gray-200 rounded-lg p-5">
                  ...
                  <p className="text-gray-600 ml-8">
                    Yes, the courses are designed for beginners as well as
                    professionals, with step-by-step learning and hands-on
                    training.
                  </p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-5">
                  ...
                  <p className="text-gray-600 ml-8">
                    AI-integrated courses prepare learners for modern job roles
                    where automation, analytics, and smart tools are essential.
                  </p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-5">
                  <h3 className="font-bold text-lg mb-2 flex items-start">
                  ...
                  <p className="text-gray-600 ml-8">
                    Yes, BM Academy offers 3 days of completely free one-to-one
                    counselling to help you choose the right career path.
                  </p>
                </div>
              </div>
            </section>
          ...
          <div className="mt-12 p-8 bg-gradient-to-r from-blue-700 to-indigo-800 rounded-2xl text-white text-center shadow-xl">
            ...
            <p className="mb-8 text-blue-100 max-w-lg mx-auto leading-relaxed">
              Don't wait for opportunities—create them with the right skills.
              Join BM Academy today.
            </p>
