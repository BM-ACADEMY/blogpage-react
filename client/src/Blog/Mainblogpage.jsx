...
const BlogPage = () => {
  const blogs = [
    {
      ...
      excerpt:
        "Master top AI tools like ChatGPT, Canva AI, Jasper & Google Ads AI in our 2025 Digital Marketing Course. Boost your career with AI skills!",
      author: "BM Academy",
      date: "Oct 14, 2025",
      image: Bannerimage1,
      avatar: bmlogo,
    ...
    },
    {
      ...
      title:
        "How BM Academy Helps Pondicherry Students Become Job‑Ready in 90 Days (Online & Offline)",
      excerpt:
        "Stop studying theory and start building your future. BM Academy’s 90-day job-ready program equips you with real-world skills, projects, and interview confidence to land your first job faster.",
      author: "BM Academy",
      date: "Dec 02, 2025",
      image: Bannerimage2,
      avatar: bmlogo,
    ...
    },
    {
      ...
      excerpt:
        "Imagine spending months learning frontend and backend development — and still being told you’re “not industry‑ready” because you lack AI skills.",
      author: "BM Academy",
      date: "Dec 19, 2025",
      image: DA,
      avatar: bmlogo,
  ...
  const pageDescription =
    "Explore insights and tips from our marketing and tech experts.";
  ...
  return (
    ...
    >
      ...
      <section className="px-[60px] pt-[40px] pb-[20px] text-left max-md:text-center max-md:px-5 max-md:pt-[30px]">
        ...
        <h2 className="text-[#6b7280] text-[16px] m-0">{pageDescription}</h2>
      </section>
